...
!(function (t, e) {
	...
	function La(t, e) {
		return (
			(ot.ScrollTrigger || Q("scrollTrigger", e)) && ot.ScrollTrigger.create(e, t)
		);
	}
	...
	function eb(t) {
		...
		return (
			...
			function (t, e, r) {
				...
				return (
					(c = (d[t] - d.min) / d.max || 0), ja(d.b + (_ ? _(c) : c) * d.v) + d.u
				);
			}
		);
	}
				...
				r
					? s(h)
						...
						: function (e) {
								...
								return (
									(o = !l || s <= l ? h[o] : e), f || o === e || t(e) ? o : o + Ya(e)
								);
						  }
					: fb(h)
			)
	...
	function Eb(t) {
		...
		if (((Rt.lastIndex = 0), Rt.test(r)))
			return (
				(e = Dt.test(r)), (t[1] = Bb(t[1], e)), (t[0] = Bb(t[0], e, Ab(t[1]))), !0
			);
	}
	function Nb(t) {
		var e = (t + "").split("("),
		...
		return (
			ha(t, function (t) {
				for (var e in ((Ft[t] = ot[t] = a), (Ft[(n = t.toLowerCase())] = r), a))
					Ft[n + ("easeIn" === e ? ".in" : "easeOut" === e ? ".out" : ".inOut")] =
						Ft[t + "." + e] = a[e];
			}),
			a
		);
		...
		qt =
			...
			(Nt.startTime = function startTime(t) {
				if (arguments.length) {
					...
					return (
						!e || (!e._sort && this.parent) || Ka(e, this, t - this._delay), this
					);
				}
				return this._start;
			}),
			...
			(Nt.reversed = function reversed(t) {
				return arguments.length
					? (!!t !== this.reversed() && this.timeScale(-this._rts || (t ? -V : 0)),
					  this)
					: this._rts < 0;
			}),
	...
	var Ut = (function (i) {
		...
		return (
			...
			(e.render = function render(t, e, r) {
				...
				if (
					(this !== L && m < v && 0 <= t && (v = m), v !== this._tTime || r || y)
				) {
					if (
						...
						if (
							((d = this._yoyo), (o = g + this._rDelay), this._repeat < -1 && t < 0)
						)
	...
	function Jd() {
		...
		if (this.tfm) {
			...
			a.svg &&
				(a.renderTransform(), i.setAttribute("data-svg-origin", this.svgo || "")),
	...
	function Rd(t) {
		...
		if (
			(Re.appendChild(r), r.appendChild(this), (this.style.display = "block"), t)
		)
			try {
			...
			for (; (o = rt.exec(i)); )
				(c = o[0]),
					...
					c !== (f = u[y++] || "") &&
						...
						_ ||
							((_ = _ || j.units[e] || m), v === i.length && ((i += _), (g.e += _))),
						m !== _ && (h = Zd(t, e, f, _) || 0),
						(g._pt = {
							_next: g._pt,
							p: p || 1 === y ? p : ",",
	...
	function ie(t, e) {
		...
		return s.svg && t.getAttribute("transform")
			...
			: (u !== yr ||
					...
					a &&
						(i ? r.insertBefore(t, i) : r ? r.appendChild(t) : Re.removeChild(t))),
